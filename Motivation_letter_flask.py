...
# local_llm_list = [item for item in config_list if item['model'] == 'LM Studio Community/Meta-Llama-3-8B-Instruct-GGUF']
...
# Calculate the ranges of experience in skills, sectors, functions, and toolingSS
...
def generate_motivation_letter(df, job_description):
    ...
    8. Lying or making up specific skills or experiences which are not in the resume is not allowed
